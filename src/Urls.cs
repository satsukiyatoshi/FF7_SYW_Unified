...
namespace FF7_SYW_Unified
{
    partial class FF7U
    {
        ...
        private void authorUrl7_Click(object sender, EventArgs e) { openUrl("https://forums.qhimm.com/index.php?topic=20612.0");}
        ...
        private void authorUrl11_Click(object sender, EventArgs e) { openUrl("https://ff7.fr/forum/index.php?page=post&ids=319186");}
